...
export async function GetRoles(params: PaginatedRequest) {
  return baseHttp.get(
    {
      url: "/role/getRoles",
    },
...
export async function GetMenusByRoleId(params: { id: UUID }) {
  return baseHttp.get(
    {
      url: "/role/getRoleMenusByRoleId",
    },
    params
  );
}

export async function GetRoleUsersByRoleId(params: { id: UUID }) {
  return baseHttp.get(
    {
      url: "/role/getRoleUsersByRoleId",
    },
    params
  );
}
...
export async function AssignUsersToRole(params: { id: UUID; userIds: UUID[] }) {
  return baseHttp.post(
    {
      url: "/role/assignUsersToRole",
    },
    params
  );
}
