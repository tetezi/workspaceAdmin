  ...
  <DialogComp>
    <template #default="data">
      <div style="width: 100%; display: flex">
        <BasicButton :func="previewFrom" type="primary" style="flex: 1"
          >预览表单</BasicButton
        >
        <BasicButton :func="showFormConfig" type="success" style="flex: 1"
          >查看配置</BasicButton
        >
      </div>
      <el-tabs v-model="activeTab" type="border-card">
        ...
        <el-tab-pane label="表单项配置" name="schema">
          <SchemasEditorComp
            v-model="schemasRef"
            style="height: 500px"
            :renderParams="[...formItemRenderParams, formMethodsRenderParams]"
          ></SchemasEditorComp>
        </el-tab-pane>
      </el-tabs>
...
const formItemRenderParams = [
  {
    label: "schema",
    code: "renderParams.schema",
    p: "当前渲染的schema",
    children: [],
  },
  {
    label: "formValue",
    code: "renderParams.formValue",
    p: "当前只读表单值",
    children: [],
  },
  {
    label: "compValue",
    code: "unref(renderParams.compValue)",
    p: "当前表单输入项双向绑定值",
    children: [],
  },
];
const formMethodsRenderParams = {
  label: "formMethods",
  code: "renderParams.formMethods",
  p: "表单操作函数",
  children: [
    {
      label: "setProps",
      code: "renderParams.formMethods.setProps(\t)",
      p: "设置表单Props",
      type: ``,
      children: [],
    },
    {
      label: "getProps",
      code: "unref(renderParams.formMethods.getProps)",
      p: "获取表单Props(ComputedRef)",
      type: ``,
      children: [],
    },
    {
      label: "setModelValue",
      code: "renderParams.formMethods.setModelValue(\t)",
      p: "设置表单值",
      type: `(val: any) => void`,
      children: [],
    },
    {
      label: "getModelValue",
      code: "unref(renderParams.formMethods.getModelValue)",
      p: "设置表单值(ComputedRef)",
    ...
    },
    {
      ...
      code: "renderParams.formMethods.setFieldsValue(\t)",
      p: "设置表单输入子项值",
      type: `(key: PropertyPath, val: any) => void`,
      children: [],
    },
    {
      label: "getFieldsValue",
      code: "renderParams.formMethods.getFieldsValue(\t)",
      p: "获取表单输入子项值",
      type: `(key: PropertyPath) => any`,
      children: [],
    },
    {
      label: "validate",
      code: "renderParams.formMethods.validate()",
      p: "校验表单（待开发）",
      type: `() => Promise<void>`,
      children: [],
    },
    {
      label: "submitFunction",
      code: "renderParams.formMethods.submitFunction()",
      p: "提交表单",
      type: `() => Promise<void>`,
      children: [],
    },
    {
      label: "getSubmitLoading",
      code: "unref(renderParams.formMethods.getSubmitLoading)",
      p: "获取当前表单提交loading状态(ComputedRef)",
      type: `ComputedRef<boolean>`,
      children: [],
    },
    {
      label: "initDefaultValue",
      code: "renderParams.formMethods.initDefaultValue()",
      p: "重置表单默认值",
      type: `() => void`,
      children: [],
    },
    {
      label: "updateSchema",
      code: "renderParams.formMethods.updateSchema(\t)",
      p: "更新表单子项配置",
      type: `(schemaKey: string,schema: Schema,isRetain?: boolean) => void`,
      children: [],
    },
    {
      label: "removeSchema",
      code: "renderParams.formMethods.removeSchema()",
      p: "删除表单子项配置",
      type: `(schemaKey: string) => void`,
      children: [],
    },
    ...
    {
      label: "getFormItemInstance",
      code: "renderParams.formMethods.getFormItemInstance(\t)",
      p: "获取表单子项组件实例",
      type: `(key: string) => ComponentPublicInstance`,
      children: [],
    },
...
const [FormComp, formMethods] = useForm({
  ...
  formSchemas: [
    ...
    },
    {
      ...
      tip: "警告！保存前回调异步钩子函数,返回参数会修改保存参数提交内容，请返回()=>Recordable|Promise<Recordable>,为空则原值保存",
      colProps: { span: 12 },
    },
    {
      field: "description",
