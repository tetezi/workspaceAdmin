...
<template>
  ...
  >
    <template v-if="dynamicFormViewCompRef">
      <FormComp
        ref="FormCompRef"
        :title="dynamicFormViewCompRef.name"
        :formSourceType="dynamicFormViewCompRef.formSourceType"
        :viewCompMethods
        :dynamicFormId="dynamicFormViewCompRef.dynamicFormId"
        :submitFunc="submitFunc"
      >
      </FormComp>
      <TableComp
        ref="TableCompRef"
        style="padding: 8 16px"
        :title="dynamicFormViewCompRef.name"
        :viewCompMethods
